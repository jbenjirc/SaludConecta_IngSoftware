 ...
 * @author LENOVO
 */
public class pacientesdatos extends javax.swing.JPanel {
...
// Convertir la fecha a un formato compatible con SQL Server
...
if (fechaNacimiento != null) {
    ...
    try {
        ...
        if (con != null) {
            String sqlUpdate = "UPDATE [CMZ_BETA].[dbo].[Empleado] SET empleado_CURP = ?, empleado_nombre = ?, empleado_paterno = ?, empleado_materno = ?, empleado_tel = ?, empleado_fechaNacimiento = ?, empleado_sueldo = ?, fechaInicio = ?, fechaFin = ?, id_usuario = ?, id_horario = ?, id_empleadoEstatus = ?, id_direccion = ? WHERE id_empleado = ?";
